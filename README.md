...
1. Praticar HTML, CSS e Figma em um projeto realista;
2. Criar uma portfólio responsivo para diferentes dispositivos;
3. Treinar a organização de seções como introdução, experiência, formação e contato;
